  ...
  return (
   ...
   <div className='skills'>
    ...
    <div className='skills'>
        ...
        <img alt='' src='https://i0.wp.com/learn.onemonth.com/wp-content/uploads/2019/07/image2-1.png?fit=600%2C315&ssl=1'/> 
        <img alt='' src='https://play-lh.googleusercontent.com/GhQVJ0wdeWzNz1k5jlb8mKNAY4qLgoF0MB8m_Oxor9KSYmq-Q4ShP43I8HLL01BVRIGT'/>
        <img alt='' src='https://adware-technologies.s3.amazonaws.com/uploads/technology/thumbnail/20/express-js.png'/>
...
<div className='baseS'><h1>गुरगृहँ गए पढ़न रघुराई। अलप काल बिद्या सब आई।।</h1></div>
    </>
  )
}
